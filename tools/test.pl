...
use Crypt::PBKDF2;
use Crypt::Argon2     qw (argon2d_raw argon2i_raw);
use Crypt::DES;
...
sub single
{
  ...
  for (my $j = 0; $j < scalar @modes; $j++)
  {
    ...
    if ($mode == 0 || $mode == 100 || $mode == 101 || $mode == 133 || $mode == 200 || $mode == 300 || $mode == 600 || $mode == 900 || $mode == 1000 || $mode == 1300 || $mode == 1400 || $mode == 1700 || $mode == 2400 || $mode == 2600 || $mode == 3500 || $mode == 4300 || $mode == 4400 || $mode == 4500 || $mode == 4600 || $mode == 4700 || $mode == 5000 || $mode == 5100 || $mode == 5300 || $mode == 5400 || $mode == 6000 || $mode == 6100 || $mode == 6600 || $mode == 6900 || $mode == 5700 || $mode == 8200 || $mode == 8300 || $mode == 9900 || $mode == 10800 || $mode == 11500 || $mode == 13300 || $mode == 15400 || $mode == 15500 || $mode == 99999)
    {
      for (my $i = 1; $i < 32; $i++)
      {
        if ($len != 0)
...
END_CODE
  ...
  elsif ($mode == 15500)
  {
    ...
    if ( $mode == 1)
    {
      $hash_buf = argon2i_raw($word_buf, $salt, 3, '1M', 1, 16);
      $tmp_hash = sprintf("\$argon2i\$v=19\$m=1024,t=3,p=1\$%s\$%s", encode_base64($salt, ''), encode_base64($hash_buf, ''));
    }
    else
    {
      $hash_buf = argon2d_raw($word_buf, $salt, 3, '1M', 1, 16);
      $tmp_hash = sprintf("\$argon2d\$v=19\$m=1024,t=3,p=1\$%s\$%s", encode_base64($salt, ''), encode_base64($hash_buf, ''));
    }
  }
  elsif ($mode == 99999)
  {
